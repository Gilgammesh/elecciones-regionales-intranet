...
/*******************************************************************************************************/
// Definimos el componente del Layout estilo Horizontal - NavBar para Móviles //
/*******************************************************************************************************/
const NavbarMobileHorizontal = props => {
	...
	return (
		<div className="flex flex-col h-full overflow-hidden">
			...
			<Scrollbars className={clsx(styles.content)}>
				<UserNavbarHeader />
...
/*******************************************************************************************************/
export default NavbarMobileHorizontal;
