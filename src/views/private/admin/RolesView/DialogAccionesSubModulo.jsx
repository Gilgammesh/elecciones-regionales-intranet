...
const DialogAccionesSubModulo = props => {
	...
	return (
		<Dialog fullWidth={true} maxWidth="sm" open={open} onClose={handleClose} aria-labelledby="accionessubmod-list">
			<DialogTitle id="accionessubmod-list">Acciones del SubMódulo {submodulo.submodulo}</DialogTitle>
			<DialogContent>
				<div>
