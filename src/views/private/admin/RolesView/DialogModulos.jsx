...
const DialogModulos = props => {
	...
	return (
		<Dialog fullWidth={true} maxWidth="lg" open={open} onClose={handleClose} aria-labelledby="modulos-list">
			...
			<DialogContent>
				<div>
					...
					{modulo && <DialogSubModulos open={openSubMod} setOpen={setOpenSubMod} modulo={modulo} />}
					{modulo && <DialogAccionesModulo open={openAccion} setOpen={setOpenAccion} modulo={modulo} />}
				</div>
			</DialogContent>
			<DialogActions>
