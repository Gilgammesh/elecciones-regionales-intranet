...
const ModulosEdit = () => {
	...
	const handleSubmit = async () => {
		...
		const result = await fetchData(`admin/modulos/${id}`, { isTokenReq: true }, 'PUT', {
			...formValues,
			children: submodulos
		});
	...
	return (
		<Formsy onValidSubmit={handleSubmit} onValid={enableButton} onInvalid={disableButton}>
			<PageCarded
				...
				content={
					<ModulosEditForm formValues={formValues} handleInputChange={handleInputChange} setForm={setForm} />
				}
				innerScroll
			/>
		</Formsy>
