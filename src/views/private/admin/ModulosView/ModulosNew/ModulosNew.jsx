...
const ModulosNew = () => {
	...
	const handleSubmit = async () => {
		...
		const result = await fetchData('admin/modulos', { isTokenReq: true }, 'POST', data);
	...
	return (
		<Formsy onValidSubmit={handleSubmit} onValid={enableButton} onInvalid={disableButton}>
			<PageCarded
				...
				content={
					<ModulosNewForm formValues={formValues} handleInputChange={handleInputChange} setForm={setForm} />
				}
				innerScroll
			/>
		</Formsy>
