...
import {
  startSetCentrosVotacionDepartamento,
  startSetCentrosVotacionProvincia
} from 'redux/actions/centrosVotacion'
  ...
  const handleProcessFile = async () => {
    ...
    if (validateFetchData(result)) {
      ...
      if (rol.super) {
        ...
        dispatch(
          startSetCentrosVotacionProvincia('todos', 'todos', 'todos', 'todos')
        )
      }
          ...
          <div className="flex flex-col col-span-12 justify-center items-center mb-20">
            <Paper className={clsx(styles.paper, 'mb-20 p-16 text-justify')}>
              ...
              <p className="mt-6">
                ...
                datos de los centros de votación y sus mesas.
              </p>
              <p className="mt-6">
              ...
              <Tooltip title="Descargar Plantilla" aria-label="add" arrow>
                {procesando ? (
                  ...
                  <Link
                    ...
                    to={{
                      pathname: `${apiBaseUrl}/uploads/centros-votacion/template.xlsx`
                    }}
                    target="_blank"
                    download
                  >
