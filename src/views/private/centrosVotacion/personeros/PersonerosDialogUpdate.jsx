...
/*******************************************************************************************************/
// Definimos la Vista del componente Centros de Votación - Personeros - Importar Excel //
/*******************************************************************************************************/
const PersonerosDialogUpdate = props => {
  ...
  const handleProcessFile = async () => {
    ...
    // Importamos los personeros
    const result = await fetchData(
      `centros-votacion/personeros/import-excel?departamento=${departamento}`,
              ...
              <Tooltip title="Descargar Plantilla" aria-label="add" arrow>
                {procesando ? (
                  ...
                  <Link
                    ...
                    to={{
                      pathname: `${apiBaseUrl}/uploads/centros-votacion/personeros/template.xlsx`
                    }}
                    target="_blank"
                    download
                  >
...
/*******************************************************************************************************/
PersonerosDialogUpdate.propTypes = {
...
/*******************************************************************************************************/
export default PersonerosDialogUpdate
