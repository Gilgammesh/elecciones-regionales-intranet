...
const DialogPersoneros = props => {
  ...
  // Efecto para limpiar el id del personero y los filtroes de búsqueda al abrirse el modal
  useEffect(() => {
    if (open) {
      setPersId(null)
      setNombres('')
        ...
        <div>
          <div className="flex flex-col justify-center w-full">
            <div className="grid grid-cols-12 gap-24 mb-16">
              ...
              <div>
                <IconButton aria-label="toggle search" onClick={handleSearchQuery} onMouseDown={handleMouseDownSearch}>
                  <SearchIcon />
                </IconButton>
              </div>
            </div>
