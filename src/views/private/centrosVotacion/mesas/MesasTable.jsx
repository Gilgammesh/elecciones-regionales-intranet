  ...
  useEffect(() => {
    ...
    const getMesas = async () => {
      ...
      const result = await fetchData(
        `centros-votacion/mesas?departamento=${departamento}&provincia=${provincia}&distrito=${distrito}&local=${local}&mesa=${mesa}&page=${
          page + 1
                    ...
                    >
                        ...
                        <div className="flex flex-row items-center">
                          {row.personero_local ? (
                            <Typography className="mr-10">
                              row.personero_local.nombres
                              row.personero_local.apellidos
                            </Typography>
                          ) : (
                      ...
                      <TableCell className="py-2" component="th" scope="row">
                        <div className="flex flex-row items-center">
                          {row.personero_mesa ? (
                            <Typography className="mr-10">
                              row.personero_mesa.nombres
                              row.personero_mesa.apellidos
                            </Typography>
                          ) : (
                            <Typography className={clsx(styles.red, 'mr-10')}>
                              --Sin asignar--
                        ...
                        {(rol.super ||
                          ...
                          <Link to={`/centros-votacion/editar/${row._id}`}>
                            ...
                            >
                              <IconButton
                                color="primary"
                                aria-label="editar centro votacion"
                              >
                                <EditIcon />
                              </IconButton>
                            </Tooltip>
