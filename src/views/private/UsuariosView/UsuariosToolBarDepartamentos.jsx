...
import { startSetUsuariosDepartamentos } from 'redux/actions/usuarios';

/*******************************************************************************************************/
// Definimos la Vista del componente Usuarios ToolBar - Departamentos //
/*******************************************************************************************************/
const UsuariosToolBarDepartamentos = () => {
	...
	const handleChange = evt => {
		...
		dispatch(startSetUsuariosDepartamentos(value));
	};
...
/*******************************************************************************************************/
export default UsuariosToolBarDepartamentos;
