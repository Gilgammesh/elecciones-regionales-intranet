...
/*******************************************************************************************************/
// Definimos la Vista del componente Elecciones Header //
/*******************************************************************************************************/
const EleccionesHeader = props => {
  ...
  // Si hay un cambio en la lista de elecciones
  useEffect(() => {
  ...
  const handleInputSearch = async evt => {
    ...
    const promises = list
      .map(ele => ele)
      .filter(ele => {
        return normalizar(ele.anho).includes(value_)
      })
    ...
    <div className="flex flex-1 w-full items-center justify-between">
      <div className="flex items-center">
        <Animate animation="transition.expandIn" delay={300}>
          <Icon className="text-32">ballot</Icon>
        </Animate>
      ...
      {(rol.super ||
        ...
        <Animate animation="transition.slideRightIn" delay={300}>
          ...
          >
            <span className="hidden sm:flex">Añadir Nueva Elección</span>
...
/*******************************************************************************************************/
export default EleccionesHeader
