...
import GobernadoresNewHeader from './GobernadoresNewHeader'
import GobernadoresNewForm from './GobernadoresNewForm'
...
/*******************************************************************************************************/
// Definimos la Vista del componente Gobernador Nuevo //
/*******************************************************************************************************/
const GobernadoresNew = () => {
  ...
  const handleSubmit = async () => {
    ...
    const result = await fetchData(
      'organizaciones-politicas/gobernadores',
  ...
  return (
    <Formsy onValidSubmit={handleSubmit} onValid={enableButton} onInvalid={disableButton}>
      <PageCarded
        ...
        header={<GobernadoresNewHeader isFormValid={isFormValid} />}
        contentToolbar={
        ...
        content={
          <GobernadoresNewForm formValues={formValues} handleInputChange={handleInputChange} setForm={setForm} />
        }
        innerScroll
      />
    </Formsy>
...
/*******************************************************************************************************/
export default GobernadoresNew
