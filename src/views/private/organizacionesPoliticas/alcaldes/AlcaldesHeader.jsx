...
/*******************************************************************************************************/
// Definimos la Vista del componente Alcaldes Header //
/*******************************************************************************************************/
const AlcaldesHeader = () => {
    ...
    <div className="flex flex-1 w-full items-center justify-between">
      ...
      {(rol.super || (accionesPerm && accionesPerm.indexOf('crear') !== -1)) && (
        <Animate animation="transition.slideRightIn" delay={300}>
          <Button
            component={Link}
            to="/organizaciones-politicas/alcaldes/nuevo"
            className="whitespace-no-wrap normal-case"
            variant="contained"
            startIcon={<AddCircleIcon />}
          >
            <span className="hidden sm:flex">Añadir Alcalde</span>
