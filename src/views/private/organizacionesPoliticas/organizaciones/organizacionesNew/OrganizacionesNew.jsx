...
import OrganizacionesNewHeader from './OrganizacionesNewHeader'
import OrganizacionesNewForm from './OrganizacionesNewForm'
...
/*******************************************************************************************************/
// Definimos la Vista del componente Organización Nuevo //
/*******************************************************************************************************/
const OrganizacionesNew = () => {
  ...
  const handleSubmit = async () => {
    ...
    // Guardamos la data de la organización
    const result = await fetchData(
      'organizaciones-politicas/organizaciones',
    ...
    if (validateFetchData(result)) {
      ...
      // Redireccionamos a lista de organizaciones politicas
  ...
  return (
    <Formsy onValidSubmit={handleSubmit} onValid={enableButton} onInvalid={disableButton}>
      <PageCarded
        ...
        header={<OrganizacionesNewHeader isFormValid={isFormValid} />}
        contentToolbar={
        ...
        content={
          <OrganizacionesNewForm formValues={formValues} handleInputChange={handleInputChange} setForm={setForm} />
        }
        innerScroll
      />
    </Formsy>
...
/*******************************************************************************************************/
export default OrganizacionesNew
