...
import { startSetConsejerosSearch, startSetConsejerosDepartamento } from 'redux/actions/consejeros'

/*******************************************************************************************************/
// Definimos la Vista del componente Consejeros ToolBar - Departamentos //
/*******************************************************************************************************/
const ConsejerosToolBarDptos = props => {
  ...
  const { departamento } = useSelector(state => state.consejeros)
  ...
  const handleChange = evt => {
    ...
    dispatch(startSetConsejerosDepartamento(value, 'todos'))
    resetPages()
  }
  ...
  return (
    <FormControl className="col-span-12 sm:col-span-2">
      <InputLabel shrink id="select-consejeros-departamento">
        Departamento
      </InputLabel>
      <Select
        labelId="select-consejeros-departamento"
...
/*******************************************************************************************************/
ConsejerosToolBarDptos.propTypes = {
...
/*******************************************************************************************************/
export default ConsejerosToolBarDptos
