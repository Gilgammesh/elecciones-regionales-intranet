...
import { Button, CircularProgress, Icon, IconButton, InputAdornment, Typography } from '@material-ui/core';
		...
		<div className="mt-16 text-center">
			...
			>
				...
				<Button
					...
					aria-label="LOG IN"
					startIcon={isLoading ? <CircularProgress className="text-white" size={20} /> : <GoSignIn />}
