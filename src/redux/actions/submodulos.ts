...
/*******************************************************************************************************/
export const startAddSubmodulo = (submodulos: Array<ISubmoduloReducer>, submodulo: ISubmoduloReducer) => {
	return (dispatch: Dispatch) => {
...
export const startUpdateSubmodulo = (
	...
	return async (dispatch: Dispatch) => {
		const promises = submodulos.filter(ele => ele.orden !== orden).map(ele => ele);
...
/*******************************************************************************************************/
export const startRemoveSubmodulo = (submodulos: Array<ISubmoduloReducer>, orden: number) => {
	return async (dispatch: Dispatch) => {
		const promises = submodulos.filter((ele: ISubmoduloReducer) => ele.orden !== orden).map(ele => ele);
