...
// export const appBaseUrl: string = process.env.REACT_APP_ELEC_URL__ || 'http://localhost:3000';
...
// export const apiBaseUrl: string = process.env.REACT_APP_API_ELEC_URL__ || 'http://localhost:4000';
